...
class CfdiJsonCreator
{
    ...
    /**
     * Encodes the given data array into a JSON string.
     *
     * @param array $data The data to be encoded.
     * @return string The JSON representation of the given data.
     */
    public function createCfdiJson(array $data): string
    {
